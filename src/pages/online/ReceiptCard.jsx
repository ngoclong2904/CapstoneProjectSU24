...
const ReceiptCard = () => {
	const { amount, refNumber, paymentTime, paymentMethod, senderName, adminFee } = receiptData
	...
	return (
		<div className='max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden  min-h-screen flex flex-col justify-center border'>
			...
			<div className='bg-black text-white text-center p-4 cursor-pointer' onClick={() => navigater("/profile")}>
				Finish
			</div>
		</div>
	)
